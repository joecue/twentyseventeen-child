...
if (is_page) {
	$neowp_social_media_facebook_title = get_post_meta( $post_id, 'neowp_social_share_og_title_field', true );
	$neowp_social_media_facebook_description = get_option( $post_id, 'neowp_social_share_og_description_field', true );
